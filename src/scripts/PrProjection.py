from spipy import phase as phr
import sys
import os
import json
...
if __name__ == '__main__':
	...
	* project structure :
	...
	# compatible to spipy 'version 3.x' project structure
	if proj_type == 2:
	...
	diff, support, good_pix, sample_known, params = phase.io_utils.read_input_h5(inputh5)
	...
	if mpi_rank == 0:
		...
		# write h5 output
		phase.io_utils.write_output_h5(\
